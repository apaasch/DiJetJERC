  ...
  for( unsigned int m = shift; m < Input.size() ; m++ ) {
    ...
    for( unsigned int p = 0; p < Input.at(m).size(); p++ ) {
      ...
      if ( Input.at(m).at(p) != 0. ) {
        ...
        if( g_year.Contains("UL16preVFP") && g_study.Contains("common_fine_v2") ){
          if(m==4){
            if(p==34) removeByHand = true;
          } else if (m==5){
            if(p>=33) removeByHand = true;
          } else if (m==6){
            if(p>=32) removeByHand = true;
          } else if (m==7){
            if(p>=31) removeByHand = true;
          } else if (m==8){
            if(p>=30) removeByHand = true;
          } else if (m==9){
            if(p>=30) removeByHand = true;
          } else if (m==10){
            if(p>=27) removeByHand = true;
          } else if (m==11){
            if(p>=27) removeByHand = true;
          } else if (m==12){
            if(p>=25) removeByHand = true;
          } else if (m==13){
            if(p>=22) removeByHand = true;
          } else if (m==14){
            if(p>=22) removeByHand = true;
          } else if (m==17){
            if(p>=15) removeByHand = true;
          } 
        }
        if( g_year.Contains("UL16postVFP") && g_study.Contains("common_fine_v2") ){
          if(m==4){
            if(p==34) removeByHand = true;
          } else if (m==5){
            if(p>=33) removeByHand = true;
            ...
            if(p>=29) removeByHand = true;
          } else if (m==10){
            if(p>=28) removeByHand = true;
          } else if (m==11){
            if(p>=26) removeByHand = true;
          } else if (m==12){
            if(p>=25) removeByHand = true;
          } else if (m==13){
            if(p>=24) removeByHand = true;
          } else if (m==14){
            if(p>=21) removeByHand = true;
          } else if (m>=16){
            if(p>=15) removeByHand = true;
          } 
        }
        ...
        if( g_year.Contains("UL18") && g_study.Contains("common_fine_v1") ){
          ...
          // if(p==9) removeByHand=true; // 160-189
        }
        if( g_year.Contains("UL18") && g_study.Contains("common_fine_v9") ){
          if(m==5){
            if(p>=36) removeByHand = true;
          } else if (m==6){
            if(p>=34) removeByHand = true;
          } else if (m==7){
            if(p>=33) removeByHand = true;
